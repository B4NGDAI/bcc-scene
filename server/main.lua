...
function dump(o)
 ...
 Citizen.CreateThread(function()
    ...
    if Config.UseDataBase == true then
        local result = exports.ghmattimysql:execute([[
...
RegisterServerEvent("bcc_scene:add", function(text,coords)
    ...
    local identi = RSGCore.Functions.GetIdentifier(source, 'steam')
    local charid = Character.cid
...
RegisterServerEvent("bcc_scene:delete", function(nr)
    ...
    if Config.UseDataBase == true then
        ...
        local Character = User.PlayerData
        if tostring(datas[nr].id) == RSGCore.Functions.GetIdentifier(source, 'steam') and tonumber(datas[nr].charid) == Character.cid then
